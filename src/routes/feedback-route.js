...
router.get('/std-feedback-route', function(req, res, next) {
...
router.post('/feedback-std', function(req, res, next) {
...
db.query(sql, [inputData.email_address] ,function (err, data, fields) {
 if(err) throw err
   ...
   db.query(sql, values, function (err, data) {
     ...
     res.redirect('/std-feedback-route');
 }
...
router.post('/feedback-fty', function(req, res, next) {
...
if(err) throw err
 ...
 db.query(sql, values, function (err, data) {
   ...
   res.redirect('/fty-feedback-route');
}
