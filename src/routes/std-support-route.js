...
router.post('/support-fty', function(req, res, next) {
...
if(err) throw err
 ...
 db.query(sql, values, function (err, data) {
   ...
   res.redirect('/fty-support-route');
}
...
router.post('/support-std', function(req, res, next) {
...
if(err) throw err
 ...
 db.query(sql, values, function (err, data) {
   ...
   res.redirect('/std-support-route');
}
